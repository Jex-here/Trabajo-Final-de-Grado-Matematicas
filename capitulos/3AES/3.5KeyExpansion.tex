...
\begin{Revision}Una palabra de $x$ bits es una cadena de $x$ bits. Sin embargo, el uso de ``palabra'' connota que el número $x$ de bits es fijo, es decir, \textit{KeyExpansion} opera fundamentalmente con cadenas de 32 bits.\end{Revision}
}.
...
La función $f_j$ toma como parámetro una cadena de 32 bits y la interpreta como un vector fila de 4 bytes: $(a,b,c,d)$. A continuación, \begin{segRevision}se \end{segRevision}realizan las siguientes operaciones:
